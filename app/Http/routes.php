...
Route::group(['middleware' => ['web','auth','level:1']], function()    
{
	...
	//cabang
	Route::get('/cabang',array('as'=>'cabang', 'uses'=> 'Cabang\CabangController@index'));
	Route::get('/cabang/{id}/hapus', array('as'=>'cabang.hapus', 'uses'=> 'Cabang\CabangController@hapus'));
	Route::post('/cabang/tambah', array('as'=>'cabang.tambah', 'uses'=> 'Cabang\CabangController@tambahcabang'));
	Route::get('/cabang/{id}/edit', array('as'=>'cabang.edit', 'uses'=> 'Cabang\CabangController@editcabang'));
	Route::put('/cabang/{id}/simpanedit', array('as'=>'cabang.simpanedit', 'uses'=> 'Cabang\CabangController@simpanedit'));

	//kejuaraan
	Route::get('/kejuaraan',array('as'=>'kejuaraan', 'uses'=> 'Kejuaraan\KejuaraanController@index'));
	Route::get('/kejuaraan/{id}/hapus', array('as'=>'kejuaraan.hapus', 'uses'=> 'Kejuaraan\KejuaraanController@hapus'));
	Route::get('/kejuaraan/{id}/aktif', array('as'=>'kejuaraan.aktif', 'uses'=>'Kejuaraan\KejuaraanController@default_aktif'));
	Route::post('/kejuaraan/tambah', array('as'=>'kejuaraan.tambah', 'uses'=> 'Kejuaraan\KejuaraanController@tambahkejuaraan'));
	Route::get('/kejuaraan/{id}/edit', array('as'=>'kejuaraan.edit', 'uses'=> 'Kejuaraan\KejuaraanController@editkejuaraan'));
	Route::put('/kejuaraan/{id}/simpanedit', array('as'=>'kejuaraan.simpanedit', 'uses'=> 'Kejuaraan\KejuaraanController@simpanedit'));

	//ukt
	Route::get('/ukt',array('as'=>'ukt', 'uses'=> 'Ukt\UktController@index'));
	Route::get('/ukt/{id}/hapus', array('as'=>'ukt.hapus', 'uses'=> 'Ukt\UktController@hapus'));
	Route::get('/ukt/{id}/aktif', array('as'=>'ukt.aktif', 'uses'=>'Ukt\UktController@default_aktif'));
	Route::post('/ukt/tambah', array('as'=>'ukt.tambah', 'uses'=> 'Ukt\UktController@tambahukt'));
	Route::get('/ukt/{id}/edit', array('as'=>'ukt.edit', 'uses'=> 'Ukt\UktController@editukt'));
	Route::put('/ukt/{id}/simpanedit', array('as'=>'ukt.simpanedit', 'uses'=> 'Ukt\UktController@simpanedit'));


	//sabuk
	Route::get('/sabuk',array('as'=>'sabuk', 'uses'=> 'Sabuk\SabukController@index'));
	Route::get('/sabuk/{id}/hapus', array('as'=>'sabuk.hapus', 'uses'=> 'Sabuk\SabukController@hapus'));
	Route::post('/sabuk/tambah', array('as'=>'sabuk.tambah', 'uses'=> 'Sabuk\SabukController@tambahsabuk'));
	Route::get('/sabuk/{id}/edit', array('as'=>'sabuk.edit', 'uses'=> 'Sabuk\SabukController@editsabuk'));
	Route::put('/sabuk/{id}/simpanedit', array('as'=>'sabuk.simpanedit', 'uses'=> 'Sabuk\SabukController@simpanedit'));

	//Anggota
	Route::get('/anggota', array('as'=>'anggota', 'uses'=>'Anggota\AnggotaController@index'));
	Route::get('/anggota/{anggotaid}/hapus', array('as'=>'anggota.hapus', 'uses'=> 'Anggota\AnggotaController@hapus'));
	Route::get('/anggota/{anggotaid}/edit', array('as'=>'anggota.edit', 'uses'=> 'Anggota\AnggotaController@edit'));
	Route::get('/anggota/tambah', array('as'=>'anggota.tambah', 'uses'=> 'Anggota\AnggotaController@tambah'));
	Route::post('/anggota/regisanggota', array('as'=>'anggota.tambah	', 'uses'=> 'Anggota\AnggotaController@regisanggota'));
	Route::get('/anggota/{anggotaid}/detail', array('as'=>'anggota.detail', 'uses'=>'Anggota\AnggotaController@detail'));
