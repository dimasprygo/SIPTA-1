      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="{{URL::to('cabang')}}"><i class="fa fa-dashboard"></i> Cabang </a>
            </li>
            <li>
              <a href="{{URL::to('sabuk')}}"><i class="fa fa-dashboard"></i> Sabuk </a>
            </li>
            <li>
              <a href="{{{URL::to('anggota')}}}"><i class="fa fa-dashboard"></i> Anggota</a>
            </li> 
            <li>
              <a href="{{{URL::to('kejuaraan')}}}"><i class="fa fa-dashboard"></i> Kejuaraan</a>
            </li>
            <li>
              <a href="{{{URL::to('ukt')}}}"><i class="fa fa-dashboard"></i> Ukt</a>
            </li>
